...
ultrasonic sens1(p5, p6, .1, 1, &dist1);
ultrasonic sens2(p7, p8, .1, 1, &dist2);
ultrasonic sens3(p9, p10, .1, 1, &dist3);
ultrasonic sens4(p11, p12, .1, 1, &dist4);
Serial pc(USBTX, USBRX);
Motor left(p21, p24, p25, 1);
Motor right(p22, p29, p30, 1);
Serial blue(p13, p14);
